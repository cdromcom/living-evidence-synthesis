...
| **Statistical rigor**: appropriate uncertainty + comparisons? | 🟡 | *"The model classification accuracy (the ratio of true positives to the total number of cases) and associated 95% CI were also calculated"* `§Analysis, p.5` |
