...
| **Data Quality**: is the released dataset FAIR? | 🟡 | FAIR-Checker (12 semantic-web metrics, 0-2 each) against https://huggingface.co/datasets/amphora/SPOT-MetaData: **9/24**. |
