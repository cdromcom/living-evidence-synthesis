...
| **Statistical rigor** — appropriate uncertainty + comparisons? | 🔴 | *"OpenReviewer 5.4 ± 1.1 ... Human Reviewers 5.4 ± 1.2"* `Table 2, p.5`, standard deviations are reported but no confidence intervals, paired significance test, or multiple-comparison correction accompany any model-vs-model gap |
