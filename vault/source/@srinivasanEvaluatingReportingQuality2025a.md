...
| **Statistical rigor**: appropriate uncertainty + comparisons? | 🟡 | *"Statistical significance was evaluated using chi-square tests for categorical comparisons and Pearson correlation for continuous relationships, with effect sizes calculated using Cramer's V"* `§3.5, p.5` |
