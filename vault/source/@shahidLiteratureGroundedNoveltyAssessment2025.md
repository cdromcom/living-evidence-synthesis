...
| **Statistical rigor**: appropriate uncertainty + comparisons? | 🔴 | *"our novelty checker achieves approximately 13% higher agreement than existing approaches"* `Abstract, p.1`, no confidence intervals or significance tests reported alongside this headline gap on a 32-idea test set |
