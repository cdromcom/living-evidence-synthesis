...
| **Statistical rigor** — appropriate uncertainty + comparisons? | 🔴 | *"Domain Patient Selection (n = 30) Index Test (n = 20) Reference Standard (n = 20) Flow and Timing (n = 40)"* `Table 3, p.9`, small per-domain samples reported with no confidence intervals or significance testing anywhere in the results |
