...
| **Statistical rigor**: appropriate uncertainty + comparisons? | 🟡 | *"Error bars represent 95% confidence intervals. *P < 0.05, **P < 0.01, ***P < 0.001, and ****P < 0.0001."* `Fig. 2 caption, p.4`, CIs and significance thresholds are reported, but no correction is stated across the many journal x aspect x metric comparisons |
